const Policy = () => {
  return (
    <div
      id='md_en'
      data-target='out_en'
      class='main-body grid text-colored agreement_md'
      style={{
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Mozaїka.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Mozaїka, accessible from{" "}
            <a
              href='https://localhost:44337/'
      ...
      <ul>
        <li>By email: mozaiika@gmail.com</li>
      </ul>
    </div>
  );
};
